...
if __name__ == "__main__":
    ...
    onsen.init()
    print("Number of designs:", len(onsen.designs))
    print("Number of strictly impossible designs:", len(onsen.impossibles))
    designs_possible = list(onsen.iter_designs_possible())
    print(
        "Number of designs that can be arranged:",
        len(designs_possible)
    )
    total_arrangements = 0
    for design in tqdm(designs_possible):
        total_arrangements += onsen.count_arrangements_design(design)
    print(
